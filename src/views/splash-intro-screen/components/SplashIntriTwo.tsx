...
import EarthDay from "../../../images/icons/earth_day.png";
import PaginationTopBar from "./DotsWithSkip";

const SplashIntroTwo = () => {
    return (
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                <Text style={styles.title}>Select Challanges & Take Eco Friendly Actions</Text>
                <Text style={styles.description}>
                    Pick daily, weekly, monthly, or yearly tasks for sustainablity.
                </Text>
                <TouchableOpacity
                    style={styles.button}
